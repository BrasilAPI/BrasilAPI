...
describe('weather prediction v1 (E2E)', () => {
  describe('Route WITHOUT number of days for prediction', () => {
    test('GET /api/cptec/v1/weather/prediction/:cityCode (Invalid City Code) ', async () => {
      const requestUrl = `${global.SERVER_URL}/api/cptec/v1/weather/prediction/9999`;
    ...
    test('GET /api/cptec/v1/weather/prediction/:cityCode', async () => {
      const requestUrl = `${global.SERVER_URL}/api/cptec/v1/weather/prediction/999`;
  ...
  describe('Route WITH number of days for query', () => {
    test('GET /api/cptec/v1/weather/prediction/:cityCode/:days', async () => {
      const requestUrl = `${global.SERVER_URL}/api/cptec/v1/weather/prediction/999/2`;
      const response = await axios.get(requestUrl);
